...
<section class="flex flex-col justify-between h-screen">
    <header class="z-10 pointer-events-none flex items-center justify-between w-full px-4 mt-4 max-w-screen-xl mx-auto">
        ...
        <svg width="70" height="70" viewBox="0 0 406 368" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                <linearGradient id="paint0_linear_23_2" x1="35.4811" y1="14.2945" x2="73.7676" y2="186.502"
                    ...
                    {{-- linear-gradient(135deg,#f936d9,#5a40e8) --}}
                    <stop stop-color="#f936d9" /> <!-- Yellow -->
                    <stop offset="1" stop-color="#5a40e8" /> <!-- Dark Orange -->
                </linearGradient>
        ...
        <div class="flex gap-4 pointer-events-auto">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                class="feather feather-sun" id="light_mode">
            ...
            <a href="https://wa.me/8580868845?text=Hi, How are you?" target="_blank">
    ...
    <div class="flex -mt-10 relative">
        <div class="w-full px-4 max-w-screen-xl mx-auto">
            ...
            <div class="relative ml-4 md:ml-12">
                ...
                <p class="pointer-events-none font-['Merriweather'] italic my-4 md:my-8">PHP Developer </p>
                 {{-- linear-gradient(135deg,#f936d9,#5a40e8) --}}
                <button
                    class="bg-[#f936d9] py-2 px-5 rounded font-extrabold bg-gradient-to-l from-[#f936d9] to-[#1f2667e6] relative hover:scale-110 ease-in-out duration-100 group">
                    About me
                    <svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#"
                        ...
                        <g transform="translate(0,-952.36218)">
                         ...
                         "
                                ...
                                fill="#fff" fill-opacity="1" stroke="white" stroke-width="2" marker="none"
        ...
        <ul class="ml-auto space-y-6 text-[#b0b2c3] absolute right-8">
            <li>
                <a href="https://www.linkedin.com/in/khem-raj/" target="_blank">
                    <svg class="w-7 hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        <path fill="currentColor"
            ...
            <li>
                <a href="https://twitter.com/khemraj" target="_blank">
                    <svg class="w-7 hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path fill="currentColor"
            ...
            <li>
                <a href="https://www.youtube.com/@khemumalurwala">
                    <svg class="w-7 hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
                        fill="currentColor">
                        <path
    ...
    <div
        ...
        <button
            class="bg-[#FFD700] py-2 px-5 rounded font-extrabold bg-gradient-to-l from-[#5a40e8] to-[#f936d9] relative hover:scale-110 ease-in-out duration-100 group mb-20">
            Latest Works
            <svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#"
                xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg"
